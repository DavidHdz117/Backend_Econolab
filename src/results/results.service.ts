      ...
      for (const section of sections) {
        ...
        if (showSectionTitle) {
          doc
            .font('Helvetica-Bold')
            .fontSize(12)
            .text(sectionTitle, left, cursorY, {
              width: right - left,
              align: 'center',
            });
        }
        ...
        if (section.result.method) {
          doc
            ...
            .fontSize(9)
            .text(
              `Metodo: ${section.result.method}`,
              left,
              cursorY + (showSectionTitle ? 16 : 0),
              {
                width: right - left,
                align: 'center',
              },
